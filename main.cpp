...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	wall[1][3] = Wall({ 9000.0f,-344.0f }, 256, 1024, 25.0f, true, BREAK, 0xFFFFFFFF, player,BREAKWALL);
	wall[1][4] = Wall({ 12000.0f,-344.0f }, 256, 1024, 30.0f, true, BREAK, 0xFFFFFFFF, player,BREAKWALL);
	...
	wall[1][7] = Wall({ 20000.0f,-534.0f }, 256, 1024, 15.0f, true, UNBREAK, 0xFFFFFFFF, player,UNBREAKWALL);
